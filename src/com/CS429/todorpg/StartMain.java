...
public class StartMain extends Activity {
	...
	private void ButtonHandler() {
		...
		findViewById(R.id.create_character_btn)
				.setOnClickListener(ButtonOption);
		findViewById(R.id.quest_creation_btn).setOnClickListener(ButtonOption);
		findViewById(R.id.availabe_quest_info_btn).setOnClickListener(
				ButtonOption);
	...
	public void CharacterCreation() {
		...
		if (!LoginStatus()) {
			Toast.makeText(this, StaticClass.NEED_LOGIN_MESSAGE,
					Toast.LENGTH_SHORT).show();
			return;
		}
		if (StaticClass.CHARACTER_CREATED) {
			Toast.makeText(this, StaticClass.HAVE_CHARACTER_MESSAGE,
					Toast.LENGTH_SHORT).show();
			return;
		}
	...
	public void CharacterInfo() {
		...
		if (!characterStatus()) {
			Toast.makeText(this, StaticClass.DONT_HAVE_CHARACTER_MESSAGE,
					Toast.LENGTH_SHORT).show();
			return;
		} 
	...
	public void LogoutHandler() {
		Toast.makeText(this, StaticClass.LOGOUT_MESSAGE, Toast.LENGTH_SHORT)
				.show();
		/*
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode == StaticClass.LOGIN_SUCCESS) {
			...
			user_id.setText(StaticClass.WELCOME_MESSAGE + " "
					+ StaticClass.MY_ID);
