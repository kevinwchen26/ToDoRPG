...
public class DailyAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.daily_list_view_row,
					parent, false);
		}

		final TextView my_daily = (TextView) convertView
				.findViewById(R.id.daily_text);
		...
		final Button check_button = (Button) convertView
				.findViewById(R.id.check_daily_button);
